...
public class AES {
	private static final String Key = "EWERWRREW4567i8o";

	public AES() {
	}

	public static byte[] encrypt(byte[] byteContent, String keyWord) {
		try {
	...
	public static String decryptByKey(String content, String keyWord) {
	...
	public static void main(String[] args) {
		String content = "1.5_20";
		System.out.println("加密前：" + content);
		String encryptResult = encrypttoStr(content, Key);
		System.out.println("加密后：" + encryptResult);
		byte[] decryptResult = decrypt("3B32BD6767C6A42E4393C4B01B64534F", Key);
