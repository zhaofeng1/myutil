...
public class ImagesUtils {
    ...
    public static String createNewImage(File _file, int createType, int newW,
        ...
        String outFileName = fileName.substring(0, fileName.lastIndexOf(".")) + "_1"
...
//            nh = (int)(h*0.5);
    ...
    public static void main(String[] args) {
        String path = "E:/logs/image/392x696bb.jpg";
        try {
            String newImage = ImagesUtils.createNewImage(new File(path), 1, 1200, 627);
